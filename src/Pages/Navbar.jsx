...
function Navbar(){
    ...
    return <Box zIndex={1} color={isscroll? darkTheme==="dark"? "white" :"white": darkTheme==="dark"? "white" : "white" } bg={isscroll? darkTheme==="dark"? "#48B3E9 " : "#48B3E9 " : darkTheme==="dark"? "#1D2143" : "#1D2143"} w="100%" p="11px 9px" boxShadow="md"  position="fixed">
        <Box w="91%" m="auto" display={["flex", "flex", "flex"]} justifyContent="space-between" textAlign={["center", "", ""]}>
            <Box >
                <Text fontFamily="inherit" fontWeight="500" paddingLeft={25} fontSize={['lg', 'sm', '3xl']}>Ansu Kumari</Text>
            </Box>
           ...
           <CiTextAlignJustify size="23px"/>
            ...
            <Box id="rt" gap={["auto", "13px", "23px"]} color={isscroll? darkTheme==="dark"? "white" :"black": darkTheme==="dark"? "white" : "white" } justifyContent={["space-around", "space-between", "space-between"]} ml="10px" alignItems="center">
                ...
                <Text color={darkTheme==="dark"?  "gray":"white" } fontFamily="inherit" fontWeight="500" fontSize={['sm', 'sm', 'lg']}><a href="https://drive.google.com/file/d/1YfATExF4w-u0N-7LiCKyCDq0oar5cXHn/view?usp=sharing">Resume</a></Text>
            </Box>
