            ...
            <Box>
                <Box p={["15px", "38px", "15px"]}>
                    ...
                    <Box display={["inline", "flex", "flex"]} gap={["", "10px", "15px"]} alignItems="center">
                        ...
                        <Text fontSize={["sm", "md", "xl"]}>ansukummari@gmail.com</Text>
                    </Box>
                    <Box display={["inline", "flex", "flex"]} gap={["", "10px", "15px"]} alignItems="center">
                        <Icon as={AiOutlineGithub} w={["40px", "30px", "40px"]} h="50px" color='white' />
                        <Text textDecoration="underline" fontSize={["sm", "md", "xl"]}><a href="https://github.com/ansu-kri" rel="noreferrer" target="_blank">https://github.com/ansu-kri</a></Text>
                    </Box>
                    <Box display={["inline", "flex", "flex"]} gap={["", "7px", "15px"]} alignItems="center">
                        <Icon as={AiOutlineLinkedin} w={["40px", "30px", "40px"]} h="50px" color='white' />
                        <Text textDecoration="underline" fontSize={["sm", "md", "lg"]}><a href="https://www.linkedin.com/in/iamansu/" rel="noreferrer" target="_blank">https://www.linkedin.com/in/iamansu/</a></Text>
                    </Box>
                    <Box display={["inline", "flex", "flex"]} gap={["", "10px", "15px"]} alignItems="center">
                        <Icon as={AiOutlineLink} w={["40px", "30px", "40px"]} h="50px" color='white' />
                        <Text textDecoration="underline" fontSize={["sm", "md", "xl"]}><a href="https://ansu-kri.github.io/" rel="noreferrer" target="_blank"></a>https://ansu-kri.github.io/</Text>
                    </Box>
                </Box>
            </Box>
        </Box>
