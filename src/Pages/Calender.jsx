    ...
    <Box bg="linear-gradient(180deg, rgba(44,23,75,1) 45%, rgba(28,14,50,1) 99%)" margin="auto" color="white" pb="60px">
        <Box w="80%" transform="scale(1.05)" m="auto" textAlign="center" p="60px auto">
            ...
            <Box m="auto" p="12px 3px" w={["90%","80%","48%"]}  >
              <Image w="100%" src="https://github-readme-stats.vercel.app/api?username=ansu-kri&theme=dark&show_icons=true&count_private=true"></Image>
            </Box>
            <Box m="auto" p="12px 3px" w={["90%","80%","48%"]}>
              <Image w="100%"  src="https://github-readme-streak-stats.herokuapp.com/?user=ansu-kri&theme=dark"></Image>
            </Box>
            </Box>
        </Box>
    </Box>
